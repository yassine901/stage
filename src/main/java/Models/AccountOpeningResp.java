...
/**
 * <p>Classe Java pour AccountOpeningResp complex type.</p>
 * 
 * <p>Le fragment de sch�ma suivant indique le contenu attendu figurant dans cette classe.</p>
 * 
 * <pre>{@code
 * <complexType name="AccountOpeningResp">
 *   <complexContent>
...
@XmlType(name = "AccountOpeningResp", propOrder = {
    "respHeader"
})
public class AccountOpeningResp {
