...
/**
 * <p>Classe Java pour FundsTransferExecuteResp complex type.</p>
 * 
 * <p>Le fragment de sch�ma suivant indique le contenu attendu figurant dans cette classe.</p>
 * 
 * <pre>{@code
 * <complexType name="FundsTransferExecuteResp">
 *   <complexContent>
...
@XmlType(name = "FundsTransferExecuteResp", propOrder = {
    "respHeader"
})
public class FundsTransferExecuteResp {
