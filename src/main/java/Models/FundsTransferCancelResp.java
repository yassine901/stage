...
/**
 * <p>Classe Java pour FundsTransferCancelResp complex type.</p>
 * 
 * <p>Le fragment de sch�ma suivant indique le contenu attendu figurant dans cette classe.</p>
 * 
 * <pre>{@code
 * <complexType name="FundsTransferCancelResp">
 *   <complexContent>
...
@XmlType(name = "FundsTransferCancelResp", propOrder = {
    "respHeader"
})
public class FundsTransferCancelResp {
